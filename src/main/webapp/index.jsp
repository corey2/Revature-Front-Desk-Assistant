            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav">
                    <li class="page-scroll home">
                        <a id="homeLoginNB" href="Login.jsp">Login</a>
                    </li>
            ...
            <div class="fullscreenbanner">
                <ul>
                    ...
                    <li data-transition="curtain-1" data-slotamount="5" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="OneTemplate/assets/img/RevImg/RevFount.jpg" alt="slidebg1" data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                        ...
                        <div class="tp-caption rs-caption-3 sft"
                            ...
                            data-captionhidden="off"
                            style="z-index: 6">
                            <span class="page-scroll"><a href="Login.jsp" class="btn-u btn-brd btn-brd-hover btn-u-light" name="homeLogin">Log In</a></span>
                           <!--  <span class="page-scroll"><a href="Login.jsp" class="btn-u btn-brd btn-brd-hover btn-u-light">Login</a></span> -->
                        </div>
                    </li>
                    ...
                    <li data-transition="slideup" data-slotamount="5" data-masterspeed="1000">
                        <!-- MAIN IMAGE -->
                        <img src="OneTemplate/assets/img/RevImg/REVANextGen.png" alt="slidebg1"  data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
                    ...
                    <li data-transition="slideup" data-slotamount="5" data-masterspeed="700">
                        <!-- MAIN IMAGE -->
                        <img src="OneTemplate/assets/img/RevImg/ashwin02.jpg"  alt="slidebg1"  data-bgfit="cover" data-bgposition="center center" data-bgrepeat="no-repeat">
