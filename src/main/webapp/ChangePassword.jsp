...
<div class="container">
    ...
    <div class="reg-block">
        <div class="reg-block-header">
            ...
            <h4>IMPORTANT: Write down the new password in your records now if you don't want to worry about forgetting it.</h4>
        ...
        <div class="input-group margin-bottom-20">
            ...
            <input type="password" name="newPassword" id="newPassword" class="form-control" data-val="true" placeholder="New Password">
            <!--   <span class="field-validation-valid" data-valmsg-for="password" data-valmsg-replace="true"></span> -->
        </div>
        <hr>    
        
        <input type=hidden name="passwordType" value="perm">
