            ...
            <div class="col-md-10 col-md-offset-1">              
                <c:choose>
					...
					<c:when test="${userRole == 2}">
						<a href="Admin.jsp"><button type="button" value="home" name="Home" class="btn-u btn-block pulse-grow">Home</button></a></br></br>
					</c:when>
					<c:otherwise>
						<a href="Login.jsp"><button type="button" value="home" name="Home" class="btn-u btn-block pulse-grow">Login</button></a></br></br>
					</c:otherwise>
				</c:choose>
