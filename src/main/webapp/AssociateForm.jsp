  ...
  <button type="button" name="Home" class="btn btn-u rounded-3x btn-u-orange"
	...
	<div class="container">
		<div class="row margin-bottom-30">
			<div class="col-md-8 mb-margin-bottom-30">
				...
				<p>Please contact Human Resources if you have any questions.</p>
				<br/>
							...
							<div class="row margin-bottom-20">
								<div class="col-md-8 col-md-offset-0">
									<input type="text" id="firstName" name="firstName"
										...
										value="${associate.firstName}" placeholder="First Name" /> <span
										class="field-validation-valid" data-valmsg-for="firstName"
							...
							<div class="row margin-bottom-20">
								<div class="col-md-8 col-md-offset-0">
									<input type="text" id="lastName" name="lastName"
										class="form-control" data-val="true"
										value="${associate.lastName}" placeholder="Last Name" required>
							...
							<div class="row margin-bottom-20">
								<div class="col-md-8 col-md-offset-0">
									<input type="text" id="email" name="email" class="form-control"
										...
										placeholder="Email" required> <span id="emailError"></span>
								</div>
							</div>
						</div>
								...
								<div class="col-md-8 col-md-offset-0">
									<input type="text" id="phoneNum" name="phoneNum"
										...
										try {
											...
											out.println("Problem with phone number:");
										}
										%>"
							...
							<div class="row margin-bottom-20">
								<div class="col-md-8 col-md-offset-0">
									<input type="text" id="address" name="address"
										class="form-control" data-val="true"
										value="${associate.address}" placeholder="Address" required>
							...
							<div class="row margin-bottom-20">
								<div class="col-md-8 col-md-offset-0">
									<input type="text" id="city" name="city" class="form-control"
										data-val="true" value="${associate.city}" placeholder="City"
							...
							<div class="row margin-bottom-20">
								<div class="col-md-8 col-md-offset-0">
									<input type="text" id="zip" name="zip" class="form-control"
										...
										value="${associate.zip}"
										placeholder="Zip"
										required> <span id="zipError"></span>
								</div>
							</div>
						</div>
							...
							<div class="row margin-bottom-20">
								<div class="col-md-8 col-md-offset-0">
									<select id="methTrans" name="methTrans" class="form-control">
										...
										<option class="active" value="Car" name="car" id="car">Car</option>
	...
	<script type="text/javascript">
		jQuery(document).ready(function() {
			...
			//arrivalDate becomes a string for some reason when it is called by JavaScript, so I need to make it a date again
			//and account for annoying timezone stuff. 
